"""
    get_modelversion(id::AbstractString)::Optional{ModelVersion}

Get a [`ModelVersion`](@ref) by id.

# Arguments
- `id::AbstractString`: The id of the model version to query.

# Returns
A [`ModelVersion`](@ref) object, or `nothing` if no record matches.
"""
get_modelversion(id::AbstractString)::Optional{ModelVersion} = fetch(ModelVersion, id)

"""
    get_modelversions(model_id::AbstractString)::Array{ModelVersion, 1}

Get every [`ModelVersion`](@ref) registered under `model_id`, ordered by version ascending.

# Arguments
- `model_id::AbstractString`: The id of the parent model.

# Returns
An array of [`ModelVersion`](@ref) objects.
"""
function get_modelversions(model_id::AbstractString)::Array{ModelVersion,1}
...
function get_modelversions(
    model_id::AbstractString, page::Pagination
...
# Arguments
- `model_id::AbstractString`: The id of the parent model.
- `iteration_id::AbstractString`: The id of the iteration that produced the checkpoint.
- `resource_id::Optional{AbstractString}`: The id of the artifact resource, or `nothing` when the
...
"""
    update_modelversion(id::AbstractString, stage_id::Optional{Integer}, description::Optional{AbstractString}, resource_id::Optional{AbstractString})::Type{<:UpsertResult}
...
# Arguments
- `id::AbstractString`: The id of the version to update.
...
- `description::Optional{AbstractString}`: The new description, or `nothing` to leave
  unchanged.
- `resource_id::Optional{AbstractString}`: The new artifact pointer, or `nothing` to leave unchanged.
...
"""
    update_modelversion(id::AbstractString, stage::Stage, description::Optional{AbstractString}, resource_id::Optional{AbstractString})::Type{<:UpsertResult}
...
"""
    delete_modelversion(id::AbstractString)::Bool
...
# Arguments
- `id::AbstractString`: The id of the version to delete.

# Returns
`true` on success, `false` otherwise.
"""
delete_modelversion(id::AbstractString)::Bool = delete(ModelVersion, id)

"""
    get_project_id(version::ModelVersion)::Optional{String}
...
"""
function get_project_id(version::ModelVersion)::Optional{String}
    model = get_model(version.model_id)
