"""
    get_parameter(client::Client, id::AbstractString)::Optional{Parameter}
...
"""
function get_parameter(client::Client, id::AbstractString)::Optional{Parameter}
    try
...
"""
    get_parameters(client::Client, iteration_id::AbstractString)::Array{Parameter,1}

Returns the first page (default limit) of [`Parameter`](@ref) records under `iteration_id`,
discarding the pagination envelope.
"""
function get_parameters(client::Client, iteration_id::AbstractString)::Array{Parameter,1}
    return get_parameters(client, iteration_id, Pagination(50, 0)).data
end

"""
    get_parameters(client::Client, iteration_id::AbstractString, page::Pagination)::PaginatedResponse{Parameter}
...
"""
    create_parameter(client::Client, iteration_id::AbstractString, key::AbstractString, value::AbstractString)::String
...
function create_parameter(
    client::Client, iteration_id::AbstractString, key::AbstractString, value::AbstractString
)::String
    response = _request(
        client,
        "POST",
...
"""
    create_parameter(client::Client, iteration_id::AbstractString, key::AbstractString, value::Real)::String
...
"""
function create_parameter(
    client::Client, iteration_id::AbstractString, key::AbstractString, value::Real
)::String
    return create_parameter(client, iteration_id, key, string(value))
end

"""
    update_parameter(client::Client, id::AbstractString; key=nothing, value=nothing)::Nothing
...
"""
    update_parameter(client::Client, id::AbstractString, value::Real; key=nothing)::Nothing

`Real`-typed overload of [`update_parameter`](@ref); stringifies `value` before sending.
"""
function update_parameter(
    client::Client, id::AbstractString, value::Real; key::Optional{AbstractString}=nothing
)::Nothing
    return update_parameter(client, id; key=key, value=(string(value)))
end

"""
    delete_parameter(client::Client, id::AbstractString)::Nothing

Delete a [`Parameter`](@ref) via `DELETE /parameter/{id}`. Requires
[`DeletePermission`](@ref) on the iteration's project.
"""
function delete_parameter(client::Client, id::AbstractString)::Nothing
